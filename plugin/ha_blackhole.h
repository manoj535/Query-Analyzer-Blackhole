...
public:
  ...
  */
  ...
  {
    return(HA_BLOCK_CONST_TABLE|HA_TABLE_SCAN_ON_INDEX|HA_PRIMARY_KEY_IN_READ_INDEX| HA_NULL_IN_KEY | HA_CAN_FULLTEXT | HA_CAN_SQL_HANDLER |
  ...
  //int rnd_same(uchar *buf, uint inx);
  //Item * idx_cond_push(uint keyno, Item* idx_cond); 
  int index_init(uint idx, bool sorted) { printf("index_init\n");active_index= idx; return 0; }
